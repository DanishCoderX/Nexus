...
interface ChatUserListProps {
  ...
  /** Where clicking a contact should navigate to. Defaults to the messages/chat page. */
  linkPrefix?: string;
}

export const ChatUserList: React.FC<ChatUserListProps> = ({ conversations, linkPrefix = '/chat' }) => {
